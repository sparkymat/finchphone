...
) RETURNING id, username, email, name, encrypted_password, created_at, updated_at
`
...
SELECT u.id, u.username, u.email, u.name, u.encrypted_password, u.created_at, u.updated_at
  FROM users u
